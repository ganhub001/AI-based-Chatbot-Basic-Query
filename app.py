...
def chatbot_response(user_input):
    ...
    responses = {
        ...
        r"\b(12|buy|order)\b": "You can place an order on our website or visit our store.",
        r"\b(13|payment methods)\b": "We accept cash, credit/debit cards, and UPI payments.",
        r"\b(14|store hours|timing)\b": "Our store is open from 8 AM to 10 PM every day.",
        r"\b(15|location|address)\b": "We are located at XYZ Market, Main Street, City.",
        r"\b(16|bye|exit)\b": "Goodbye! Happy shopping! 🛍"
    }
